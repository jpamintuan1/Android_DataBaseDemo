package com.example.josep.databasedemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            eventsDB.execSQL("INSERT INTO newUsers (name, age) VALUES ('ASS', 21)");

            eventsDB.execSQL("INSERT INTO newUsers (name, age) VALUES ('FUCKYOU', 1)");
